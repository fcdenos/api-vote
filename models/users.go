...
type User struct {
	...
	VoteDone  null.Bool   `boil:"vote_done" json:"vote_done,omitempty" toml:"vote_done" yaml:"vote_done,omitempty"`
...
var UserWhere = struct {
	...
	Pass:      whereHelpernull_String{field: "\"users\".\"pass\""},
	VoteDone:  whereHelpernull_Bool{field: "\"users\".\"vote_done\""},
}
...
var (
	userAllColumns            = []string{"uuid", "created_at", "updated_at", "deleted_at", "first_name", "last_name", "email", "pass", "vote_done"}
	userColumnsWithoutDefault = []string{"uuid", "created_at", "updated_at", "deleted_at", "first_name", "last_name", "email", "pass", "vote_done"}
